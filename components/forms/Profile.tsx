    ...
    <ScrollArea className="form-wrapper">
      <div className="form-content">
        <div className="form-header mb-6">
          <div className="form-title">Profile Section</div>
          <div className="form-description">Your personal and professional introduction.</div>
        </div>
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="form-section">
                <h3 className="form-section-title">Primary Button</h3>
                {/* Label Input */}
                <div className="space-y-2">
              ...
              <div className="form-section">
                <h3 className="form-section-title">Secondary Button</h3>
                {/* Label Input */}
                <div className="space-y-2">
